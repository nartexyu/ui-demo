    ...
    return (
                ...
                >
                    <div className="flex flex-col items-center justify-center h-full">
                        ...
                        <div
                            ...
                            index === 0 ? 'bg-white text-black hover:bg-red-300' : index === 1 ? 'bg-white text-black hover:bg-teal-200' : index === 2 ? 'bg-white text-black hover:bg-purple-400' : index === 3 ? 'bg-white text-black hover:bg-blue-300' : 'bg-black text-white'
                            }`}
                            style={{ opacity: 100 }}
        ...
        {/* Desktop Header */}
            <div className="hidden lg:grid bg-white text-black border-black grid-cols-10 items-end font-mono">
                <h1 className="lg:text-3xl font-bold col-span-5 p-8 flex items-start">UI DEMO</h1>
                <div 
