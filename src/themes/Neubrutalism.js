...
const Neubrutalism = () => {
    ...
    useEffect(() => {
        ...
        if (window.innerWidth > 1024) {
            ...
            gsap.fromTo(
                svg,
                { rotation: 0 }, // Adjust the transform origin as needed
                {
                rotation: 90,
                scrollTrigger: {
                    trigger: svg,
            ...
            { y: '-20%' },
            {
                y: '15%', // Adjust the value to control how far it slides down
                scrollTrigger: {
    ...
    return (
        ...
        <section className="relative p-8 bg-lime-200 -mt-5 lg:-mt-20 z-10 pb-24">
