...
Thanks for taking the time to check out my project! I haven't had time to make it perfectly responsive yet, so it's preferable for you to use a decently large screen to view it!
...
**Screenshots:**
![Neumorphism Screenshot](/public/screenshots/Neumorphism.PNG)
...
**Screenshots:**
![Bauhaus Screenshot](/public/screenshots/Bauhaus.PNG)
...
**Screenshots:**
![Retro-Futurism Screenshot 1](/public/screenshots/Retro-futurism.PNG)
